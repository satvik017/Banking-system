...
namespace BankSystem.Controllers
{
    ...
    {       
        ...
        {
            var datasource = @"LAPTOP-ITPGICJI";//your server
            var database = "BankSystem"; //your database name
            var username = "LAPTOP-ITPGICJI\\HP"; //username of server to connect
            var password = ""; //password
                                        //your connection string 
            string connString = "Server= LAPTOP-ITPGICJI; Database= BankSystem; Integrated Security=True;";
        ...
        public ActionResult Balance()
        {
            ...
            string constring = System.Configuration.ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString;
            SqlConnection con = new SqlConnection(GetConnectionString());   
            Console.WriteLine(Session["loginSession"].ToString());
